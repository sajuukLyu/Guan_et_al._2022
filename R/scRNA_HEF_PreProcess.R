...
usedSample <- c(
  "HEF", "S2D20", "S2-T", "S2-5", "S2-J", "prime_HEF")

dataList <- map(str_c("data/HEF_scRNA/", usedSample), Read10X)
...
saveRDS(allSo, "middata/HEF_scRNA/allSo_raw.rds")

# quality control ---------------------------------------------------------

allSo <- readRDS("middata/HEF_scRNA/allSo_raw.rds")
...
saveRDS(allSo, "middata/HEF_scRNA/allSo_qc.rds")
